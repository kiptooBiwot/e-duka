...
<template>
  <div id="MenuOverlay" class="fixed z-50 bottom-0 h-full w-full bg-white px-3">
    <div class="flex items-center justify-between py-5">
      <NuxtLink to="/" @click="userStore.isMenuOverlay = false" class="min-w-[170px]">
        <h2 class="font-semibold font-title text-2xl"><span class="text-[#F69716]">E-</span><span
    ...
    <div class="flex items-center justify-between pt-5">
      <ul class="w-full">
        ...
        <li v-if="user" @click="signOut()" class="
                        relative 
                        flex 
                        items-center 
                        justify-between 
