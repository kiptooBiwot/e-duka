...
const images = ref([
  ...
  'https://picsum.photos/id/267/800/800',
])
...
<template>
  <div id="ItemPage" class="mt-4 max-w-[1200px] mx-auto px-2">
    <div class="md:flex gap-4 justify-between mx-auto w-full">
      <div class="md:w-[40%]">
        <img v-if="currentImage" :src="currentImage" class="rounded-lg object-fit transition duration-500 ease-in-out"
          alt="">
        ...
        <div v-if="images[0] !== ''" class="flex items-center justify-center mt-2">
          <div v-for="image in images" :key="image">
            <img :src="image" @mouseover="currentImage = image" @click="currentImage = image" width="70"
              ...
              :class="currentImage === image ? 'border-[#ff4646]' : ''" alt="">
          </div>
        </div>
      </div>

      <div class="md:w-[60%] bg-white p-3 rounded-lg">
        <div v-if="product && product.data" class="">
        ...
        <div class="flex items-center pt-1.5">
          <span class="h-4 min-w-4 rounded-full p-0.5 bg-[#ffd000] mr-2">
            <Icon name="material-symbols:star-rounded" size="12" class="-mt-[17px]" />
          </span>
          <p class="text-[#ff4646]">Extra 5% off</p>
        </div>
        ...
        <div class="flex items-center justify-start my-2">
          ...
          <Icon name="ic:baseline-star" color="#ff5353" />
          <Icon name="ic:baseline-star" color="#ff5353" />
          <span class="text-[13px] font-light ml-2">5 453 Reviews 1,000+ Orders</span>
        </div>
